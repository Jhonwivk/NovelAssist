// 内置设定模板（与后端 templates.module.ts 的 BUILTIN_TEMPLATES 同源；前端用于首屏即时展示，
// 用户自建模板从 GET /api/templates 一并拉取合并）。
...
export const BUILTIN_TEMPLATES: Template[] = [
  {
    name: '都市重生',
    genre: '都市', theme: '重生', trope: '重生逆袭 / 复仇打脸',
  ...
  {
    name: '末世危机',
    genre: '科幻', theme: '末世生存', trope: '囤物资 / 异能觉醒',
  ...
  {
    name: '玄幻升级',
    genre: '玄幻', theme: '修真升级', trope: '废柴逆袭 / 无敌流',
  ...
  {
    name: '系统流',
    genre: '都市', theme: '系统', trope: '任务奖励 / 签到',
  ...
  {
    name: '无限流',
    genre: '科幻', theme: '无限流', trope: '副本闯关 / 智斗',
  ...
  {
    name: '修真问道',
    genre: '仙侠', theme: '修仙', trope: '问道长生 / 宗门风云',
  ...
  {
    name: '星际机甲',
    genre: '科幻', theme: '星际战争', trope: '机甲 / 舰队征伐',
  ...
  {
    name: '言情甜宠',
    genre: '言情', theme: '甜宠', trope: '霸总 / 双向奔赴',
  ...
  {
    name: '悬疑推理',
    genre: '悬疑', theme: '探案', trope: '层层反转 / 智斗凶手',
...
export const GENRES = ['玄幻', '仙侠', '都市', '科幻', '历史', '悬疑', '言情', '游戏', '体育', '现实', '军事', '其它'];
export const AUDIENCES = ['男频', '女频', '全年龄', '青少年'];
